...
<!DOCTYPE html>
	...
	<div class="container" style="margin-top:50px">
		...
		<form:form action="${pageContext.request.contextPath}/contact/edit/${contact.id}" class="form-horizontal" commandName="contact">
	    	<fieldset>
	    		...
	    		<tags:form_field label="Date de naissance" name="dateOfBirth" placeholder="JJ/MM/AAA" path="dateOfBirth"/>
