...
<div class="card address" style="margin:auto;margin-top:15px">
	<div class="card-top green">
    	...
    	<form name="remove" class="pull-right" method="post" action="${pageContext.request.contextPath}/address/delete/${contactId}/${address.id}">
			...
			<button class="btn btn-default navbar-btn pull-right"
				title="Edition"
				onclick="window.location ='${pageContext.request.contextPath}/address/edit/${contactId}/${address.id}'">
				<i class="fa fa-cog"></i>
			</button>
    </div>
